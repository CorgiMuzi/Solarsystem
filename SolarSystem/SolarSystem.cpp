...
// SolarSystem.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
CSolarSystemApp::CSolarSystemApp() noexcept
{
	...
	SetAppID(_T("SolarSystem.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CSolarSystemApp 개체입니다.
...
BOOL CSolarSystemApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_SolarSystemTYPE,
...
int CSolarSystemApp::ExitInstance()
{
...
// CSolarSystemApp 사용자 지정 로드/저장 방법
